# FILE AUTOMATICALLY GENERATED FROM /Users/alucazzz/.zimrc
# EDIT THE SOURCE FILE AND THEN RUN zimfw build. DO NOT DIRECTLY EDIT THIS FILE!

if [[ -e ${ZIM_CONFIG_FILE:-${ZDOTDIR:-${HOME}}/.zimrc} ]] zimfw() { source "${HOME}/.dotfiles/shell/zsh/.zim/zimfw.zsh" "${@}" }
fpath=("${HOME}/.dotfiles/shell/zsh/.zim/modules/git-info/functions" "${HOME}/.dotfiles/shell/zsh/.zim/modules/completion/functions" "${HOME}/.dotfiles/shell/zsh/.zim/modules/smite/functions" ${fpath})
autoload -Uz -- coalesce git-action git-info smite
...
source "${HOME}/.dotfiles/shell/zsh/.zim/modules/fzf/init.zsh"
